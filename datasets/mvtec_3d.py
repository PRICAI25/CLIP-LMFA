...
class MVTec_3DDataset(BaseDataset):
    CLASSNAMES = [
        "bagel",
        "cable_gland",
        "carrot",
    ...
    def get_image_data(self):
        ...
        for classname in self.classnames_to_use:
            ...
            maskpath = self.source / classname / self.split.value
            ...
            for anomaly_path in anomaly_paths:
                ...
                anomaly_path_truth =  anomaly_path / "rgb"
                anomaly_files = sorted(anomaly_path_truth.glob("*"))
                # 获取图像文件路径
                ...
                if self.split == DatasetSplit.TEST and anomaly != "good":
                    anomaly_mask_path = maskpath / anomaly / "gt"
