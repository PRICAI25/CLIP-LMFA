...
class Retina_RESCDataset(BaseDataset):
    CLASSNAMES = [
        "Retina_RESC_AD",
    ]
    ...
    def get_image_data(self):
        ...
        for classname in self.classnames_to_use:
            ...
            for anomaly_path in anomaly_paths:
                ...
                if str(anomaly_path) == '/home/wsc/BMVC-FADE-main/data/Med/Retina_RESC_AD/Retina_RESC_AD/valid/Ungood' and split_value == 'valid':
