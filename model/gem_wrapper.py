"""
  @Author: 王权
  @FileName: gem_wrapper.py
  @DateTime: 2025/3/19 13:18
  @SoftWare: PyCharm
"""
import numpy as np
import torch
...
from .gem_utils import SelfSelfAttention, GEMResidualBlock, modified_vit_forward, EnhancedGEMResidualBlock
...
class GEMWrapper(nn.Module):
    ...
    def apply_gem(self):
        for i in range(1, self.depth):
            ...
            # self.model.visual.transformer.resblocks[-i] = EnhancedGEMResidualBlock(
            #     res_block=self.model.visual.transformer.resblocks[-i])
    ...
    def forward(self, image: torch.Tensor, text: list, normalize: bool = True, return_ori: bool =False):
        ...
        # image_feat, t_ = image_head(image_feat, text_embeddings)
        # text_embeddings = text_head(text_embeddings)
        # text_embeddings = 0.9 * text_embeddings + 0.1 * t_
        #
        # Image-Text matching
